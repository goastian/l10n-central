...
warn-on-open-many-tabs =
    ...
    .accesskey = d
switch-to-new-tabs =
    .label = リンク、画像、メディアを新規タブで開いたとき、すぐにそのタブに切り替える
    .accesskey = h
...
preferences-colors-header = カラー
preferences-colors-description = ウェブサイトのテキスト、背景、リンクを、{ -brand-short-name } のデフォルトカラーで上書きする。
...
preferences-text-zoom-override-warning =
    .message = 警告: [文字サイズのみ変更] を選択し、デフォルトズームが 100% でない場合、一部のサイトやコンテンツが正しく表示されない可能性があります。
language-header = 言語
...
applications-description = ウェブからダウンロードしたファイルを { -brand-short-name } が取り扱う方法と閲覧中に使用するアプリケーションを選んでください。
applications-filter =
    .placeholder = ファイルの種類とアプリケーションを検索
...
applications-use-os-default =
    .label =
        { PLATFORM() ->
            [macos] macOS のデフォルトアプリケーションを使用
            [windows] Windows のデフォルトアプリケーションを使用
           *[other] システムのデフォルトアプリケーションを使用
        }
...
home-new-windows-tabs-header = 新規ウインドウとタブ
home-new-windows-tabs-description2 = ホームページ、新規ウインドウ、新規タブを開くときに表示するものを選択してください。

## Home Section - Home Page Customization

home-homepage-mode-label = ホームページと新規ウインドウ
home-newtabs-mode-label = 新規タブ
...
search-engine-default-desc-2 = アドレスバーと検索バーのデフォルト検索エンジンです。いつでも切り替えられます。
search-engine-default-private-desc-2 = プライベートウインドウでのデフォルト検索エンジンを選択してください
search-separate-default-engine =
    .label = この検索エンジンをプライベートウインドウで使用する
    .accesskey = U
...
search-show-search-term-option =
    .label = デフォルト検索エンジンの結果ページで URL の代わりに検索語句を表示する
...
sync-mobile-promo = Midori for <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> または <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> をダウンロードしてモバイル端末と同期しましょう。
...
content-blocking-private-windows = プライベートウインドウのトラッキングコンテンツ
...
content-blocking-all-windows-tracking-content = すべてのウインドウのトラッキングコンテンツ
...
httpsonly-radio-enabled =
    .label = すべてのウインドウで HTTPS-Only モードを有効にする
httpsonly-radio-enabled-pbm =
    .label = プライベートウインドウのみ HTTPS-Only モードを有効にする
...
preferences-doh-default-detailed-desc-2 = 安全な DNS プロバイダーで問題がある場合、デフォルト DNS リゾルバーを使用します
...
preferences-doh-enabled-detailed-desc-2 = 安全な DNS で問題がある場合のみ、デフォルト DNS リゾルバーを使用します
...
preferences-doh-setting-off =
    .label = オフ
    .accesskey = O
preferences-doh-off-desc = デフォルト DNS リゾルバーを使用します
