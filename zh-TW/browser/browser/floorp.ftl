...
about-floorp = <label data-l10n-name="floorp-browser-link">{ -brand-product-name }</label> 它是一款快速、安全的輕量級瀏覽器，致力於用戶隱私和安全。 <label data-l10n-name="ablaze-Link">{ -vendor-short-name }</label> 運行，旨在促進網絡發展。 想支持我們？ <label data-l10n-name="helpus-donateLink">點此捐款</label>
