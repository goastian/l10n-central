...
default-bookmarks-firefox-customize = Midori aanpassen
...
default-bookmarks-nightly-heading = Midori Nightly-bronnen

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Midori Nightly-blog

# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Ablaze-bugtracker
...
default-bookmarks-crashes = Al uw crashes
