...
about-floorp = <label data-l10n-name="floorp-browser-link">{ -brand-product-name }</label> ユーザーのプライバシーとセキュリティを重視した、軽量、高速、安全なブラウザです。 <label data-l10n-name="ablaze-Link">{ -vendor-short-name }</label> の下でウェブをより良くするために作られています。 参加・応援をしたいですか？ <label data-l10n-name="helpus-donateLink">寄付</label> をご検討ください。
...
gf-floorp-close-sidebar-description = Midoriのサイドバーを閉じます。
...
memo-third-tip = あなたのメモは Midori ブラウザーの設定に保存されます。Firefox Sync は、パスワードによって暗号化されているため、あなた以外の他の人に見られることはありません。もちろん Astian や Midori は、あなたのメモを読むことはできません。Firefox Sync はバックアップ機能ではないため、メモは必ずバックアップを取ってください。
memo-fourth-tip = Midori Notes は、Midori のブラウザーマネージャーサイドバーまたは、「about:notes」を URL に入力すること開くことができます。
memo-new-title = 新規メモ
