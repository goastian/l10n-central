...
downloading-red-color = 
    .label = 다운로드할 때 빨간색 다운로드 아이콘을 사용하기
...
sidebar2-enable-addons-desc = 광고 차단 확장 프로그램 및 기타 확장 프로그램이 사이드바에서 작동하게 됩니다. 하지만 모든 확장 프로그램이 작동하는 것은 아닙니다.
...
######################################################################### Default bookmarks ###############################################################
default-bookmark-ablaze-support = Astian 지원
...
reorder-this-workspace-to-up = 
    .label = 이 워크스페이스를 위로 옮기기
    .accesskey = B
reorder-this-workspace-to-down = 
    .label = 이 워크스페이스를 아래로 옮기기
    .accesskey = A
...
floorp-custom-actions-open-downloads = 다운로드 열기
    .label = 다운로드 열기
floorp-custom-actions-show-bms = 브라우저 관리자 사이드바 표시 전환하기
    .label = 브라우저 관리자 사이드바 표시 전환하기
floorp-custom-actions-show-current-panel = 현재 패널 표시 전환
    .label = 현재 패널 표시 전환
