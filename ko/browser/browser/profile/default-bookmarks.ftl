...
default-bookmarks-firefox-customize = Midori 사용자 지정
...
default-bookmarks-nightly-heading = Midori Nightly 리소스

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Midori Nightly 블로그
