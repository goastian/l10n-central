...
design-header = Diseño

feature-requires-restart = Reinicia para aplicar los cambios
...
ui-preference = Apariencia de Midori
...
UserAgent-preference = Agente de usuario
...
memory-and-performance = Modos de rendimiento
...
save-memo = Guardar
memo-welcome-title = Bienvenido!
memo-first-tip = Bienvenido a Midori Notas! Here are some instructions on how to use it!
...
######################################################################### Default bookmarks ###############################################################
default-bookmark-ablaze-support = Soporte Astian
default-bookmark-notes = Midori Notas
...
workspace-button = Espacios de trabajo
  .label = Espacios de trabajo
  .tooltiptext = Selecciona una espacio de trabajo...
...
welcome-to-floorp = Bienvenido a { -brand-short-name }!
welcome-discribe-floorp = { -brand-short-name } Es un navegador ligero rapido y seguro comprometido con la privacidad y la seguridad de los usuarios.
welcome-start-setup = Listo para el viaje?
welcome-skip-to-start-browsing = Omitir y empezar a navegar
welcome-select-preferences-template = Seleccione una plantilla
welcome-minimum-template = Basico
welcome-enable-basic-features = Habilite funciones y configuraciones básicas para una experiencia sencilla.
welcome-medium-template = Default
welcome-enable-some-features = Habilite funciones y configuraciones adicionales para una mejor experiencia.
welcome-maximum-template = Avanzado
welcome-enable-most-of-features = Habilite funciones y configuraciones avanzadas. Recomendado para usuarios experimentados..
welcome-go-next-setup = Siguiente
welcome-select-browser-design = Seleccione el diseño de Midori
welcome-discribe-browser-design = Puedes elegir uno de los maravillosos diseños de { -brand-short-name }. Los diseños específicos del sistema operativo también están disponibles en Preferencias.
...
welcome-import-data = Trae tu información
welcome-import-data-description = ¡Configuración rápida! Importe sus marcadores, contraseñas y más desde su antiguo navegador. El usuario de Firefox puede importar datos desde Firefox Sync.
welcome-import-data-button = Importar Datos...
welcome-import-data-skip = Omitir
welcome-select-button = Seleccionar
welcome-finish-setup = Configuración completa!
welcome-finish-setup-description = ¡Estás listo! Otras configuraciones como pestañas verticales y complementos se pueden encontrar en el menú de preferencias. Disfrutar { -brand-short-name }!
welcomet-finish-setup = Comience a navegar por la web con Midori
...
floorp-custom-actions-zoom-in = Aumentar Zoom
  .label = Aumentar Zoom
floorp-custom-actions-zoom-out = Disminuir Zoom
  .label = Disminuir Zoom
floorp-custom-actions-reset-zoom = Reiniciar Zoom
  .label = Reiniciar Zoom
floorp-custom-actions-back = Atras
  .label = Atras
floorp-custom-actions-forward = Adelante
  .label = Adelante
floorp-custom-actions-reload = Refrescar
  .label = Refrescar
floorp-custom-actions-stop = Detener
  .label = Detener
floorp-custom-actions-force-reload = Forzar recarga
  .label = Forzar recarga
floorp-custom-actions-search-in-this-page = Buscar en esta pagina
  .label = Buscar en pagina
floorp-custom-actions-show-next-search-result = Mostrar la siguiente palabra de búsqueda en el resultado de esta página
  .label = Siguiente resultado de "Buscar en la página"
...
floorp-custom-actions-open-task-manager = Abrir administrador de tareas
  .label = Open { -brand-short-name }'s Administrador de tareas
...
floorp-profiles-in-use = Este pefil esta en uso.
floorp-profiles-title = Perfiles
floorp-profile-manager = Administrador de perfil
floorp-profiles-create = Crear perfil
floorp-profile = Profile
 .label = Administrador de perfil
 .tooltiptext = Abrir administrador de perfil
