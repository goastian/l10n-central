...
welcome-start-setup = ¿Listo para sumergirte?
...
welcome-enable-basic-features = Activa las funciones y ajustes básicos para disfrutar de una experiencia sencilla.
welcome-medium-template = Predeterminado
welcome-enable-some-features = Habilita funciones y ajustes adicionales para disfrutar de una mejor experiencia.
welcome-maximum-template = Avanzado
welcome-enable-most-of-features = Habilitar funciones y ajustes avanzados. Recomendado para usuarios con experiencia.
welcome-go-next-setup = Siguiente
welcome-select-browser-design = Seleccione un diseño del navegador
welcome-describe-browser-design = Puede elegir uno de los maravillosos { -brand-short-name } diseños. Los diseños específicos para cada sistema operativo también están disponibles en Preferencias.
...
welcome-import-data-description = Quick setup! Importa tus marcadores, contraseñas y mucho más desde tu antiguo navegador. Los usuarios de Firefox pueden importar datos desde Firefox Sync.
...
welcome-finish-setup-description = Ya está todo listo. Otras funciones como las pestañas verticales y los espacios de trabajo se encuentran en { -brand-short-name }'s Ajustes. Disfruta de { -brand-short-name }!
